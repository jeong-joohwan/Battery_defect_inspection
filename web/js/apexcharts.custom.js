...
var columnChart, columnChartoptions = {
    series: [{
        name: "Orders",
        data: [32, 66, 44, 55, 41, 24, 67, 22, 43, 32]
    }, {
        name: "Visitors",
        data: [7, 30, 13, 23, 20, 12, 8, 13, 27, 7]
    }],
    chart: {
        type: "bar",
        height: 210,
    ...
    xaxis: {
        type: "datetime",
        categories: ["01/01/2020 GMT", "01/02/2020 GMT", "01/03/2020 GMT", "01/04/2020 GMT", 
        "01/05/2020 GMT", "01/06/2020 GMT", "01/07/2020 GMT", "01/08/2020 GMT", "01/09/2020 GMT", "01/10/2020 GMT"],
        labels: {
            show: !0,
            trim: !0,
            minHeight: void 0,
...
var barChart, barChartoptions = {
    ...
    barChartCtn = document.querySelector("#barChart2");
barChartCtn && (barChart = new ApexCharts(barChartCtn, barChartoptions)).render();
...
var barChart, barChartoptions = {
    ...
    barChartCtn = document.querySelector("#barChart3");
barChartCtn && (barChart = new ApexCharts(barChartCtn, barChartoptions)).render();
...
var barChart, barChartoptions = {
    ...
    barChartCtn = document.querySelector("#barChart4");
barChartCtn && (barChart = new ApexCharts(barChartCtn, barChartoptions)).render();
...
var lineChart, lineChartoptions = {
    series: [{
        name: "Temperature",
        data: [22.4, 25.8, 20.9, 23.9, 23.7, 27.9, 23.5, 20.8, 23.3, 23.4, 23.8, 22.8, 21.9, 23.2, 24.8, 23, 22.8, 23.4]
    },
    // {
    //     name: "Visitors",
    ...
    xaxis: {
        type: "datetime",
        categories: ["10/01/2020 GMT", "10/02/2020 GMT", "10/03/2020 GMT", "10/04/2020 GMT", "10/05/2020 GMT", "10/06/2020 GMT", "10/07/2020 GMT", "10/08/2020 GMT", "10/09/2020 GMT", "10/10/2020 GMT", "10/11/2020 GMT", "10/12/2020 GMT", "10/13/2020 GMT", "10/14/2020 GMT", "10/15/2020 GMT", "10/16/2020 GMT", "10/17/2020 GMT", "10/18/2020 GMT"],
        labels: {
            show: !0,
            trim: !1,
            minHeight: void 0,
...
lineChartCtn = document.querySelector("#lineChart1");
...
//     {
//     name: "Temperature",
//     data: [23.3, 23.4, 23.8, 22.8, 21.9, 23.2, 24.8, 23, 22.8, 23.4, 22.4, 25.8, 20.9, 23.9, 23.7, 27.9, 23.5, 20.8 ]
// },
{
    name: "Temperature",
    data: [23.3, 23.4, 23.8, 22.8, 21.9, 23.2, 24.8, 23, 22.8, 23.4, 22.4, 25.8, 20.9, 23.9, 23.7, 27.9, 23.5, 20.8]
...
lineChartCtn = document.querySelector("#lineChart2");
lineChartCtn && (lineChart = new ApexCharts(lineChartCtn, lineChartoptions)).render();
...
{
    name: "Temperature",
    data: [23.8, 22.8, 21.9, 23.2, 20.9, 23.9, 23.7, 27.9, 23.5, 20.8, 24.8, 23, 22.8, 23.4, 22.4, 25.8, 23.3, 23.4]
}, 
// {
//     name: "Orders",
//     data: [5, 25, 9, 14, 14, 32, 21, 5, 12, 25, 5, 55, 9, 14, 14, 32, 21, 65]
...
lineChartCtn = document.querySelector("#lineChart3");
lineChartCtn && (lineChart = new ApexCharts(lineChartCtn, lineChartoptions)).render();
...
donutchartCtn = document.querySelector("#donutChart3");
donutchartCtn && (donutchart = new ApexCharts(donutchartCtn, donutChartOptions)).render();
